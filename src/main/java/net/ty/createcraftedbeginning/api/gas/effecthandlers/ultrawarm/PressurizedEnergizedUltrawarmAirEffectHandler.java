...
public class PressurizedEnergizedUltrawarmAirEffectHandler extends UltrawarmAirEffectHandler {
    @Override
    public void apply(@NotNull Level level, @NotNull BlockPos pos, Direction direction, @NotNull Gas gasType) {
        applyEffects(level, pos, direction, gasType.getInflation(), gasType.getTint(), 20);
    }
}
