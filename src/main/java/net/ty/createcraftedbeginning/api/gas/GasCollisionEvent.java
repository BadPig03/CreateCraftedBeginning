...
public class GasCollisionEvent extends Event {
    protected final Gas firstGas, secondGas;
    private final Level level;
    private final BlockPos pos;
    @Nullable
    private BlockState state;

    protected GasCollisionEvent(Level level, BlockPos pos, Gas firstGas, Gas secondGas, @Nullable BlockState defaultState) {
        this.level = level;
        this.pos = pos;
