...
public class UltrawarmAirEffectHandler implements AirtightDrainageHandler {
    ...
    protected void applyEffects(Level level, BlockPos pos, Direction direction, float inflation, int tint, int scale) {
        showOutline(level, pos, direction, inflation, tint);
