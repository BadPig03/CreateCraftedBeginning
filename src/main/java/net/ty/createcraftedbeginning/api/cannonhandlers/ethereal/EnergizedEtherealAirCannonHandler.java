package net.ty.createcraftedbeginning.api.cannonhandlers.ethereal;
...
public class EnergizedEtherealAirCannonHandler extends EtherealAirCannonHandler {
    ...
    public void explode(Level level, Vec3 pos, Entity source, float multiplier) {
        ...
        DamageSource damageSource = CCBDamageTypes.source(DamageTypes.MAGIC, level, source);
    ...
    public ResourceLocation getTextureLocation() {
        return CreateCraftedBeginning.asResource("textures/entity/projectiles/energized_ethereal_wind_charge.png");
    }
