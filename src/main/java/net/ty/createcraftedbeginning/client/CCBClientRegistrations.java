...
public final class CCBClientRegistrations {
    ...
    public static void initialize() {
        ...
        models.register(CreateCraftedBeginning.asResource("airtight_pipe"), AirtightPipeAttachmentModel::withAO);
        models.register(CreateCraftedBeginning.asResource("airtight_check_valve"), AirtightPipeAttachmentModel::withAO);
        models.register(CreateCraftedBeginning.asResource("smart_airtight_pipe"), AirtightPipeAttachmentModel::withAO);
        models.register(CreateCraftedBeginning.asResource("airtight_pump"), AirtightPipeAttachmentModel::withAO);
        models.register(CreateCraftedBeginning.asResource("gas_factory_gauge"), GasFactoryGaugeModel::new);
    }
