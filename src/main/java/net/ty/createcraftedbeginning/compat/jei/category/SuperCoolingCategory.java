...
public class SuperCoolingCategory extends CCBRecipeCategory<SuperCoolingRecipe> {
    private final AnimatedBreezeChamber chamber = new AnimatedBreezeChamber().withFrost(true);

    public SuperCoolingCategory(Info<SuperCoolingRecipe> info) {
        super(info);
    }

    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, SuperCoolingRecipe recipe, @NotNull IFocusGroup focuses) {
    ...
    @Override
    public void draw(SuperCoolingRecipe recipe, IRecipeSlotsView iRecipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {
