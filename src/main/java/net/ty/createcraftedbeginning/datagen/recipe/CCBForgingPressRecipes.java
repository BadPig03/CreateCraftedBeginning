...
public class CCBForgingPressRecipes extends ForgingPressRecipeGen {
    private final GeneratedRecipe DIAMOND_FROM_CHARCOAL = create("diamond_from_charcoal", builder -> builder.require(Items.CHARCOAL).require(Items.HEAVY_CORE).require(CCBGases.PRESSURIZED_ENERGIZED_ULTRAWARM_AIR.get(), 250).output(0.2f, Items.DIAMOND));
