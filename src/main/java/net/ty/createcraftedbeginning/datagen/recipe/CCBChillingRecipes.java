...
public class CCBChillingRecipes extends ChillingRecipeGen {
    ...
    public GeneratedRecipe PACKED_ICE = create("packed_ice", b -> b.require(Blocks.ICE).output(Blocks.PACKED_ICE));
    public GeneratedRecipe BLUE_ICE = create("blue_ice", b -> b.require(Blocks.PACKED_ICE).output(Blocks.BLUE_ICE));
