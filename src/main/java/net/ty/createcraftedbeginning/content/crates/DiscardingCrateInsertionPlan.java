...
record DiscardingCrateInsertionPlan(ItemStack content, int count, boolean trackedDiscard) {
    static DiscardingCrateInsertionPlan plan(ItemStack storedContent, int storedCount, ItemStack incomingStack, int maxCount, Predicate<ItemStack> trackedItemPredicate) {
