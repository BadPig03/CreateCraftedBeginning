...
public class EndIncinerationBlowerRenderer extends KineticBlockEntityRenderer<EndIncinerationBlowerBlockEntity> {
    ...
    @Override
    protected void renderSafe(@NotNull EndIncinerationBlowerBlockEntity be, float partialTicks, PoseStack ms, @NotNull MultiBufferSource buffer, int light, int overlay) {
    ...
    @Override
    protected SuperByteBuffer getRotatedModel(EndIncinerationBlowerBlockEntity be, BlockState blockState) {
