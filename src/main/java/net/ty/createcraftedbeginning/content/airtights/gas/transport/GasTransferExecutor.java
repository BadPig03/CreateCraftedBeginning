...
public final class GasTransferExecutor {
    ...
    public static GasStack simulateSourceDrain(IGasHandler sourceHandler, GasStack gasType, long maxAmount) {
    ...
    public static GasStack executeTransferPlan(IGasHandler sourceHandler, GasStack gasType, List<PlannedTransfer> transferPlan) {
    ...
    public static GasStack executeTargetPlan(GasStack availableGas, List<PlannedTransfer> transferPlan) {
