...
@OnlyIn(Dist.CLIENT)
public class AirtightBootScreen extends AirtightUpgradableScreen<AirtightBootsMenu> {
    public AirtightBootScreen(AirtightBootsMenu menu, Inventory inv, Component title) {
