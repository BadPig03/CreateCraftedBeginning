...
public final class GasInjectionChamberBasinCompat {
    ...
    public static void markHookVerified() {
        hookVerified = true;
    }

    public static boolean isHookVerified() {
        return hookVerified;
    }
    ...
    public static @Nullable TransactionView getTransactionView(BasinBlockEntity basin) {
    ...
    public record TransactionView(SmartFluidTankBehaviour inputTank, SmartFluidTankBehaviour outputTank, BasinTransactionAccess transactionAccess) {
        public TransactionSnapshot snapshot(Provider provider) {
        ...
        public void restore(Provider provider, TransactionSnapshot snapshot) {
    ...
    public record TransactionSnapshot(FluidTankSnapshot tanks, List<FluidStack> outputBuffer) {}
}
