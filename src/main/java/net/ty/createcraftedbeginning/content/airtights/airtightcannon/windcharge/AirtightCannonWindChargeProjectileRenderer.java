...
@OnlyIn(Dist.CLIENT)
public class AirtightCannonWindChargeProjectileRenderer extends EntityRenderer<AirtightCannonWindChargeProjectileEntity> {
    private static final double MIN_CAMERA_DISTANCE_SQUARED = 16.0d;

    public AirtightCannonWindChargeProjectileRenderer(Context context) {
        super(context);
    }
