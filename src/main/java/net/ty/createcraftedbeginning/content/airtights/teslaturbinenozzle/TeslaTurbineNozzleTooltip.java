...
public final class TeslaTurbineNozzleTooltip {
    ...
    public boolean addToGoggleTooltip(List<Component> tooltip) {
        ...
        boolean clockwise = nozzle.getBlockState().getValue(TeslaTurbineNozzleBlock.CLOCKWISE);
        String directionKey = clockwise ? "gui.tesla_turbine_nozzle.flow_direction.clockwise" : "gui.tesla_turbine_nozzle.flow_direction.counter_clockwise";
