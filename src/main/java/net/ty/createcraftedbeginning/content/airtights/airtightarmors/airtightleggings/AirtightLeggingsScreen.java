...
public class AirtightLeggingsScreen extends AirtightUpgradableScreen<AirtightLeggingsMenu> {
    ...
    protected void initButtons() {
        ...
        AirtightLeggingsUpgradeRegistry.forEach(upgrade -> {
            ...
            buttonConfigsMap.put(upgrade, new AirtightUpgradableScreen.ScreenButtonConfig(button, upgrade.getTitle(), upgrade.getDescription(), () -> button.green, () -> !menu.getStatus(upgrade).isInstalled() && button.active, () -> upgrade.getGasCostComponent(menu.player), upgrade.getUpgradeItem()));
