...
public class AirtightLeggingsUpgradeRegistry {
    ...
    public static void registerUpgrades() {
        register(ProjectileDeflectionUpgrade.INSTANCE);
        register(QuickSwimmingUpgrade.INSTANCE);
        register(SwiftSneakUpgrade.INSTANCE);
        register(CrammingProtectionUpgrade.INSTANCE);
        register(BlastResistanceUpgrade.INSTANCE);
        register(LeggingsResistanceUpgrade.INSTANCE);
    }
}
