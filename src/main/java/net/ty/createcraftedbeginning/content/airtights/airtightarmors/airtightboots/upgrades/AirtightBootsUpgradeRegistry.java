...
public class AirtightBootsUpgradeRegistry {
    ...
    public static boolean allUpgradesActive(Player player) {
        ...
        return boots.is(CCBItems.AIRTIGHT_BOOTS) && ORDERED_UPGRADES.stream().allMatch(upgrade -> upgrade.isEnabled(boots));
    }
    ...
    public static void registerUpgrades() {
        register(MovementEfficiencyUpgrade.INSTANCE);
        register(JumpStrengthUpgrade.INSTANCE);
        register(StepHeightUpgrade.INSTANCE);
        register(EnvironmentalDamageProtectionUpgrade.INSTANCE);
        register(FallProtectionUpgrade.INSTANCE);
        register(BootsResistanceUpgrade.INSTANCE);
    }
}
