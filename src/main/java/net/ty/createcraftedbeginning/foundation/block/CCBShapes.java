...
public class CCBShapes {
    ...
    public static final VoxelShaper BOILER_STEAM_OUTLET = shape(1, 0, 1, 15, 3, 15).add(3, 2, 3, 13, 13, 13).add(4, 13, 4, 12, 15, 12).add(4, 4, 1, 12, 12, 3).add(1, 4, 4, 3, 12, 12).add(13, 4, 4, 15, 12, 12).add(4, 4, 13, 12, 12, 15).forDirectional(Direction.UP);
