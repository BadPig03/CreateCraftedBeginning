...
public class CCBMenuTypes {
    ...
    public static final MenuEntry<GasFactoryGaugeSetGasMenu> GAS_FACTORY_GAUGE_SET_GAS_MENU = register("gas_factory_gauge_set_gas", GasFactoryGaugeSetGasMenu::new, () -> GasFactoryGaugeSetGasScreen::new);
