...
public class CCBAdvancements implements DataProvider {
    ...
    public static final CCBAdvancement MINTY_FRESH = create("minty_fresh", b -> b.icon(p -> GasVirtualUtils.createVirtualItem(new GasStack(CCBGases.PRESSURIZED_ENERGIZED_ETHEREAL_AIR, 1))).title("Minty Fresh").description("Drain Pressurized Energized Ethereal Air into the world").special(GOAL).after(LUXURY_TREAT));
