...
public class CCBFluids {
    ...
    public static final FluidEntry<AirFakeFluid> AIR = CCB_REGISTRATE.air_fluid("air").lang("Air").register();
    ...
    public static final FluidEntry<VirtualTimeVirtualFluid> VIRTUAL_TIME = CCB_REGISTRATE.virtual_time("virtual_time").lang("Virtual Time").register();
