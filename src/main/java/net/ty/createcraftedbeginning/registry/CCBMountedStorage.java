...
import net.ty.createcraftedbeginning.api.gas.GasTankMountedStorageType;
...
public class CCBMountedStorage {
    ...
    public static final RegistryEntry<MountedGasStorageType<?>, GasTankMountedStorageType> GAS_TANK = simpleGas("airtight_tank", GasTankMountedStorageType::new);
