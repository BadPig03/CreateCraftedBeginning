...
public class CCBDataComponents {
    ...
    public static final DataComponentType<UUID> GAS_CANISTER_PACK_UUID = register("gas_canister_pack_uuid", builder -> builder.persistent(UUIDUtil.CODEC).networkSynchronized(UUIDUtil.STREAM_CODEC));
