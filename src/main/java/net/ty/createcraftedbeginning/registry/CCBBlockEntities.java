...
import net.ty.createcraftedbeginning.content.cindernozzle.CinderNozzleRenderer;
...
public class CCBBlockEntities {
    ...
    public static final BlockEntityEntry<CinderNozzleBlockEntity> CINDER_NOZZLE = CREATE_REGISTRATE.blockEntity("cinder_nozzle", CinderNozzleBlockEntity::new)
        .validBlocks(CCBBlocks.CINDER_NOZZLE_BLOCK)
        .renderer(() -> CinderNozzleRenderer::new)
        .register();
