...
public class CCBCoolingRecipes extends CoolingRecipeGen {
    ...
    WATER = create("water", b -> b.require(Fluids.WATER, 200).output(CCBFluids.COOLING_TIME.get(), 3)),

    WATER_BUCKET = create("water_bucket", b -> b.require(Items.WATER_BUCKET).output(CCBFluids.COOLING_TIME.get(), 15));
