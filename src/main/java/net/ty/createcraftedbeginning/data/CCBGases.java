...
public class CCBGases {
    ...
    public static final GasHolder<Gas, Gas> MOIST_AIR = GAS_REGISTER.register("moist_air", builder().tint(0xFFBEDAED).inflation(1).engineEfficiency(1).teslaEfficiency(1).outputFluidStack(() -> new FluidStack(Fluids.WATER, 1)).tag(CCBGasTags.MOIST.tag));
    public static final GasHolder<Gas, Gas> SPORE_AIR = GAS_REGISTER.register("spore_air", builder().tint(0XFFE8F5C4).inflation(1).engineEfficiency(1.8f).teslaEfficiency(1.8f).tag(CCBGasTags.SPORE.tag));

    public static final GasHolder<Gas, Gas> ENERGIZED_NATURAL_AIR = GAS_REGISTER.register("energized_natural_air", builder().inflation(1).tint(0xFFD2D5FB).pressurizedGas(CreateCraftedBeginning.asResource("pressurized_energized_natural_air")).engineEfficiency(0).teslaEfficiency(2).tag(CCBGasTags.NATURAL.tag).tag(CCBGasTags.ENERGIZED.tag));
    public static final GasHolder<Gas, Gas> ENERGIZED_ULTRAWARM_AIR = GAS_REGISTER.register("energized_ultrawarm_air", builder().inflation(1).tint(0xFFF2D8BC).pressurizedGas(CreateCraftedBeginning.asResource("pressurized_energized_ultrawarm_air")).engineEfficiency(0).teslaEfficiency(2.8f).tag(CCBGasTags.ULTRAWARM.tag).tag(CCBGasTags.ENERGIZED.tag));
    public static final GasHolder<Gas, Gas> ENERGIZED_ETHEREAL_AIR = GAS_REGISTER.register("energized_ethereal_air", builder().inflation(1).tint(0xFFF5C3F6).pressurizedGas(CreateCraftedBeginning.asResource("pressurized_energized_ethereal_air")).engineEfficiency(0).teslaEfficiency(4).tag(CCBGasTags.ETHEREAL.tag).tag(CCBGasTags.ENERGIZED.tag));

    public static final GasHolder<Gas, Gas> PRESSURIZED_NATURAL_AIR = GAS_REGISTER.register("pressurized_natural_air", builder().inflation(2).tint(0xFF999CBC).energizedGas(CreateCraftedBeginning.asResource("pressurized_energized_natural_air")).engineEfficiency(4).teslaEfficiency(4).tag(CCBGasTags.NATURAL.tag).tag(CCBGasTags.PRESSURIZED.tag));
    public static final GasHolder<Gas, Gas> PRESSURIZED_ULTRAWARM_AIR = GAS_REGISTER.register("pressurized_ultrawarm_air", builder().inflation(2).tint(0xFFB59E86).energizedGas(CreateCraftedBeginning.asResource("pressurized_energized_ultrawarm_air")).engineEfficiency(6).teslaEfficiency(6).tag(CCBGasTags.ULTRAWARM.tag).tag(CCBGasTags.PRESSURIZED.tag));
    public static final GasHolder<Gas, Gas> PRESSURIZED_ETHEREAL_AIR = GAS_REGISTER.register("pressurized_ethereal_air", builder().inflation(2).tint(0xFFB88CB8).energizedGas(CreateCraftedBeginning.asResource("pressurized_energized_ethereal_air")).engineEfficiency(8).teslaEfficiency(8).tag(CCBGasTags.ETHEREAL.tag).tag(CCBGasTags.PRESSURIZED.tag));
