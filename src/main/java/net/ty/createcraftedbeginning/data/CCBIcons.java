...
public class CCBIcons extends AllIcons {
    ...
    public static final CCBIcons I_EFFECTS_PROTECTION = newRow();
    public static final CCBIcons I_WATER_BREATHING = next();
    public static final CCBIcons I_GOGGLES = next();
    public static final CCBIcons I_VISION = next();
    public static final CCBIcons I_SPECTRAL = next();
    public static final CCBIcons I_RESISTANCE = next();
    public static final CCBIcons I_ELYTRA = next();
    public static final CCBIcons I_CREATIVE_FLIGHT = next();
    public static final CCBIcons I_INVISIBILITY = next();
    public static final CCBIcons I_REGENERATION = next();
    public static final CCBIcons I_HASTE = next();
    public static final CCBIcons I_PROJECTILE_DEFLECTION = next();
    public static final CCBIcons I_QUICK_SWIMMING = next();
    public static final CCBIcons I_SWIFT_SNEAK = next();
    public static final CCBIcons I_CRAMMING_PROTECTION = next();
    public static final CCBIcons I_BLAST_RESISTANCE = next();
    public static final CCBIcons I_MOVEMENT_EFFICIENCY = newRow();
    public static final CCBIcons I_JUMP_STRENGTH = next();
