...
public class CCBChillingRecipes extends ChillingRecipeGen {
    GeneratedRecipe ICE_FROM_WATER_BUCKET = create("ice_from_water_bucket", b -> b.require(Items.WATER_BUCKET).output(Blocks.ICE).output(Items.BUCKET));
    ...
    GeneratedRecipe OBSIDIAN_FROM_LAVA_BUCKET = create("obsidian_from_lava_bucket", b -> b.require(Items.LAVA_BUCKET).output(Blocks.OBSIDIAN).output(Items.BUCKET));
