...
public class CCBAirtights extends ConfigBase {
    ...
    public final ConfigBool copyComponentsOnlyWithSmithingTemplates = b(true, "copy_components_only_with_smithing_templates", Comments.copyComponentsOnlyWithSmithingTemplates);
    ...
    public final ConfigInt maxPumpRange = i(32, 1, 64, "max_pump_range", Comments.blocks, Comments.maxPumpRange);
    @SuppressWarnings("unused")
    ...
    private static class Comments {
        ...
        private static final String copyComponentsOnlyWithSmithingTemplates = "Whether the Airtight Forging Press copies input item components to the primary output only when the press head is a smithing upgrade or armor trim template. Disable to always copy input components.";
        ...
        private static final String maxPumpRange = "The maximum distance, measured through connected pipe blocks, that an Airtight Pump can affect in either direction.";
