...
public class CCBAirtights extends ConfigBase {
    ...
    public final ConfigBool forgingPressCopyComponentsOnlyWithSmithingTemplates = b(true, "copy_components_only_with_smithing_templates", Comments.forgingPressCopyComponentsOnlyWithSmithingTemplates);
    ...
    private static class Comments {
        ...
        private static final String forgingPressCopyComponentsOnlyWithSmithingTemplates = "Whether the Airtight Forging Press copies input item components to the primary output only when the press head is a smithing upgrade or armor trim template. Disable to always copy input components.";
