...
public class CCBClient extends ConfigBase {
    ...
    //public final ConfigBool enableExtendArmFirstPersonArm = b(true, "enable_extend_arm_first_person_arm", Comments.enableExtendArmFirstPersonArm);
    ...
    private static class Comments {
        ...
        //static String enableExtendArmFirstPersonArm = "Displays the first-person arm when equipping Airtight Extend Arms.";
