...
public class CCBClient extends ConfigBase {
    ...
    public final ConfigBool enableCinderIncinerationBlowerOutline = b(true, "enable_cinder_incineration_blower_outline", Comments.enableCinderIncinerationBlowerOutline);
    ...
    private static class Comments {
        ...
        static String enableCinderIncinerationBlowerOutline = "Displays the working range of the Cinder Incineration Blower.";
