...
import net.ty.createcraftedbeginning.api.coolantstrategy.BreezeCoolerCoolantStrategy;
import net.ty.createcraftedbeginning.api.coolantstrategy.CoolantStrategyHandler;
import net.ty.createcraftedbeginning.api.coolantstrategy.DowngradeCoolantStrategy;
