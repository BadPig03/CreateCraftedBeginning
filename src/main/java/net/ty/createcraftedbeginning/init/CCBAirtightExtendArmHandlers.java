...
import net.ty.createcraftedbeginning.api.gas.armhandlers.DefaultArmHandler;
...
public class CCBAirtightExtendArmHandlers {
    public static void register() {
        ...
        DefaultArmHandler defaultHandler = new DefaultArmHandler();
        ...
        registry.register(CCBGases.MOIST_AIR.get(), defaultHandler);
        registry.register(CCBGases.SPORE_AIR.get(), defaultHandler);
        registry.register(CCBGases.SCULK_AIR.get(), defaultHandler);
