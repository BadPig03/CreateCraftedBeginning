...
public class PhotoStressBearingScenes {
    public static void scene(SceneBuilder builder, @NotNull SceneBuildingUtil util) {
        ...
        scene.world().modifyBlock(gearboxPos, s -> s.setValue(BlockStateProperties.AXIS, Axis.Z), false);
        scene.world().setBlock(shaftPos, AllBlocks.SHAFT.getDefaultState(), false);
        scene.world().modifyBlock(shaftPos, s -> s.setValue(BlockStateProperties.AXIS, Axis.X), false);
