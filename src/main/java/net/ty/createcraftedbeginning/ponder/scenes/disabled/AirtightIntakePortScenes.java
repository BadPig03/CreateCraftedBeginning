...
public class AirtightIntakePortScenes {
    public static void scene(SceneBuilder builder, @NotNull SceneBuildingUtil util) {
        ...
        scene.world().setBlock(cogPos, AllBlocks.COGWHEEL.getDefaultState().setValue(CogWheelBlock.AXIS, Axis.X), false);
        scene.world().setBlock(pipePos, CCBBlocks.AIRTIGHT_PIPE_BLOCK.getDefaultState().setValue(AirtightPipeBlock.AXIS, Axis.X), false);
