...
public class EndSculkSilencerScenes {
    public static void scene(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Vec3 silencerTopVec = util.vector().centerOf(silencerTopPos);
        ...
        scene.overlay().showText(60).text("The End Sculk Silencer must be placed on an End Casing").colored(PonderPalette.RED).pointAt(Vec3.atCenterOf(silencerPos)).placeNearTarget().attachKeyFrame();
        ...
        scene.idle(80);
        scene.overlay().showFilterSlotInput(silencerSideVec.add(0, 0, -0.0625), Direction.NORTH, 60);
        ...
        scene.overlay().showText(60).text("\"3x3\": 3x3 chunks").pointAt(silencerTopVec).placeNearTarget().attachKeyFrame();
