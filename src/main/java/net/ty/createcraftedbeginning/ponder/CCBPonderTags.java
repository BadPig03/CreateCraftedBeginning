...
public class CCBPonderTags {
    ...
    public static void register(PonderTagRegistrationHelper<ResourceLocation> helper) {
        ...
        helper.registerTag(KINETIC_APPLIANCES_TAG_ID).addToIndex().item(CCBBlocks.CINDER_NOZZLE_BLOCK.get()).register();
        ...
        ENTRY_HELPER.addToTag(KINETIC_APPLIANCES_TAG_ID).add(CCBBlocks.CINDER_NOZZLE_BLOCK);
        ENTRY_HELPER.addToTag(AllCreatePonderTags.KINETIC_APPLIANCES).add(CCBBlocks.CINDER_NOZZLE_BLOCK);
    }
}