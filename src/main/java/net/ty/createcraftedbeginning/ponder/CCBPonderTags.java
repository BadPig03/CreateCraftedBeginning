...
public class CCBPonderTags {
    ...
    public static final ResourceLocation BREEZE_CHAMBERS_TAG_ID = ResourceLocation.fromNamespaceAndPath(CreateCraftedBeginning.MOD_ID, "breeze_chambers");
    ...
    public static void register(PonderTagRegistrationHelper<ResourceLocation> helper) {
        ...
        helper.registerTag(BREEZE_CHAMBERS_TAG_ID).addToIndex().item(CCBBlocks.BREEZE_CHAMBER_BLOCK.get()).register();
        ...
        ENTRY_HELPER.addToTag(AllCreatePonderTags.ARM_TARGETS).add(CCBBlocks.BREEZE_CHAMBER_BLOCK);

        ENTRY_HELPER.addToTag(BREEZE_CHAMBERS_TAG_ID).add(CCBBlocks.EMPTY_BREEZE_CHAMBER_BLOCK);
        ENTRY_HELPER.addToTag(BREEZE_CHAMBERS_TAG_ID).add(CCBBlocks.BREEZE_CHAMBER_BLOCK);
    }
}