...
public class CCBPonderTags {
    ...
    public static void register(PonderTagRegistrationHelper<ResourceLocation> helper) {
        ...
        entryHelper.addToTag(GAS_CONTAINERS_TAG_ID).add(CCBBlocks.AIRTIGHT_TANK_BLOCK).add(CCBBlocks.HORIZONTAL_AIRTIGHT_TANK_BLOCK).add(CCBBlocks.CREATIVE_AIRTIGHT_TANK_BLOCK).add(CCBItems.GAS_CANISTER).add(CCBItems.GAS_CANISTER_PACK);
